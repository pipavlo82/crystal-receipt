...
PKG = ROOT / "conformance/verifier-challenge-chronicle-checkpoint-root-mismatch-rejected-v0"
VECTOR_ID = "V-CHRONICLE-CHECKPOINT-ROOT-MISMATCH"

members = [
    "conformance/verifier-challenge-chronicle-checkpoint-root-mismatch-rejected-v0/SPEC.md",
...
vector = json.loads((PKG / "vectors/V-CHRONICLE-CHECKPOINT-ROOT-MISMATCH.json").read_text(encoding="utf-8"))
...
contract = {
    "schema": "verifier_challenge_chronicle_checkpoint_root_mismatch_rejected_contract.v0",
    "package_version": "verifier-challenge-chronicle-checkpoint-root-mismatch-rejected-v0",
    "profile_id": "verifier-challenge-chronicle-checkpoint-root-mismatch-rejected-v0",
    "challenge_id": "checkpoint_root_mismatch_rejected",
    "authority": {
        "normative_spec": "conformance/verifier-challenge-chronicle-checkpoint-root-mismatch-rejected-v0/SPEC.md",
    ...
    "required_vector_fields": [
        ...
        "root_integrity_control",
        "expected",
    ],
    "forbidden_semantics": [
        "noncanonical_entry_refs_order",
        "field_specific_root_input_mutations",
        "missing_null_checkpoint_root",
        "duplicate_entry_refs_prohibition",
        "shape_validation",
    ...
    "independence_scope": {
        ...
        "challenge_semantics": "Independent verifier validates substitution scope, canonical-order controls, root-integrity relations, and encoded local verification results from frozen spec.",
...
files = []
for path in sorted(members + ["conformance/verifier-challenge-chronicle-checkpoint-root-mismatch-rejected-v0/contract.json"]):
...
manifest = {
    "schema": "verifier_challenge_chronicle_checkpoint_root_mismatch_rejected_fixture_manifest.v0",
    "package_version": "verifier-challenge-chronicle-checkpoint-root-mismatch-rejected-v0",
