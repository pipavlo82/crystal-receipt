...
PKG = ROOT / "conformance/verifier-challenge-observed-not-validated-v0"

members = [
    "conformance/verifier-challenge-observed-not-validated-v0/SPEC.md",
...
vector = json.loads((PKG / "vectors/V-OBSERVED-NOT-VALIDATED.json").read_text(encoding="utf-8"))
exp = json.dumps(vector["expected"], ensure_ascii=False, separators=(",", ":"), sort_keys=True)
result_hash = hashlib.sha256(f"V-OBSERVED-NOT-VALIDATED\t{hashlib.sha256(exp.encode()).hexdigest()}\n".encode()).hexdigest()

contract = {
    "schema": "verifier_challenge_observed_not_validated_contract.v0",
    "package_version": "verifier-challenge-observed-not-validated-v0",
    "profile_id": "verifier-challenge-observed-not-validated-v0",
    "challenge_id": "observed_not_validated",
    "authority": {
        "normative_spec": "conformance/verifier-challenge-observed-not-validated-v0/SPEC.md",
        "production_binding": "src/receiptos/verify/verify-receipt.ts",
        "prototype_precedent": "tests/receiptos/verifier-challenge-observed-not-validated.prototype.test.ts",
    },
    ...
    "verifier_entrypoint": {
        ...
        "git_blob_oid": "b453db974c3d49280f4adfc69d66002c20020277",
    },
    "source_fixture_identity": {
        "repository_path": "src/receiptos/fixtures/session-evidence.cyphes-workflow.sample.json",
        "git_blob_oid": "879efae676e513db96f12e3c69774243525c822e",
    },
    "vector_inventory": ["V-OBSERVED-NOT-VALIDATED"],
    ...
    "vector_execution_classes": {
        ...
        "vectors": {
            "V-OBSERVED-NOT-VALIDATED": {"execution_class": "production-verifier-binding"},
        },
    },
    "independence_scope": {
        "package_identity": "Python and TypeScript auditors recompute member and expected-result digests without production imports.",
        "challenge_semantics": "Independent verifier validates mutation scope, field classification, and encoded non-elevation relation from frozen spec.",
...
files.append({"path": "conformance/verifier-challenge-observed-not-validated-v0/contract.json", "sha256": contract_hash})
files.sort(key=lambda item: item["path"])
file_rows = [f'{item["path"]}\t{item["sha256"]}\n' for item in files]
fixture_hash = hashlib.sha256("".join(file_rows).encode()).hexdigest()

manifest = {
    "schema": "verifier_challenge_observed_not_validated_fixture_manifest.v0",
    "package_version": "verifier-challenge-observed-not-validated-v0",
