...
PKG = ROOT / "conformance/verifier-challenge-chronicle-sequence-gap-rejected-v0"

members = [
    "conformance/verifier-challenge-chronicle-sequence-gap-rejected-v0/SPEC.md",
...
vector = json.loads((PKG / "vectors/V-CHRONICLE-SEQUENCE-GAP.json").read_text(encoding="utf-8"))
exp = json.dumps(vector["expected"], ensure_ascii=False, separators=(",", ":"), sort_keys=True)
result_hash = hashlib.sha256(
    f"V-CHRONICLE-SEQUENCE-GAP\t{hashlib.sha256(exp.encode()).hexdigest()}\n".encode()
).hexdigest()

contract = {
    "schema": "verifier_challenge_chronicle_sequence_gap_rejected_contract.v0",
    "package_version": "verifier-challenge-chronicle-sequence-gap-rejected-v0",
    "profile_id": "verifier-challenge-chronicle-sequence-gap-rejected-v0",
    "challenge_id": "sequence_gap_rejected",
    "authority": {
        "normative_spec": "conformance/verifier-challenge-chronicle-sequence-gap-rejected-v0/SPEC.md",
    ...
    "required_vector_fields": [
        ...
        "reference_binding_control",
        "sequence_relation_control",
    ...
    "forbidden_semantics": [
        ...
        "all_sequence_reason_codes",
        "global_chain_ordering",
    ...
    "source_fixture_identity": {
        ...
        "precedent_vector_name": "sequence_gap",
    },
    ...
    "vector_inventory": ["V-CHRONICLE-SEQUENCE-GAP"],
    ...
    "vector_execution_classes": {
        ...
        "vectors": {
            "V-CHRONICLE-SEQUENCE-GAP": {"execution_class": "production-continuity-binding"},
        },
    },
    "independence_scope": {
        "package_identity": "Python and TypeScript auditors recompute member and expected-result digests without production imports.",
        "challenge_semantics": "Independent verifier validates current substitution scope, ref-match control, sequence relation, and encoded continuity results from frozen spec.",
...
files.append({"path": "conformance/verifier-challenge-chronicle-sequence-gap-rejected-v0/contract.json", "sha256": contract_hash})
files.sort(key=lambda item: item["path"])
file_rows = [f'{item["path"]}\t{item["sha256"]}\n' for item in files]
fixture_hash = hashlib.sha256("".join(file_rows).encode()).hexdigest()

manifest = {
    "schema": "verifier_challenge_chronicle_sequence_gap_rejected_fixture_manifest.v0",
    "package_version": "verifier-challenge-chronicle-sequence-gap-rejected-v0",
