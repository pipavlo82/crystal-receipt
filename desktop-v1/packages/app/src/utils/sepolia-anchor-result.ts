...
/**
 * In the Merkle-first product flow, legacy `receiptRoot` returned by
 * anchor-root.mjs is interpreted as the anchored Merkle root.
 * Therefore it must match current evidence.anchor.merkle_root.
 */
