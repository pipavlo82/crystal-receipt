...
export const DESKTOP_MENU: DesktopMenu[] = [
  ...
  },
  {
    ...
    label: "Help",
    items: [
      { type: "item", label: "Stealth Documentation", href: "https://github.com/CYPHES-ATP/Stealth#readme" },
      { type: "item", label: "Support Forum", href: "https://github.com/CYPHES-ATP/Stealth/issues" },
      { type: "item", label: "Export Logs...", command: "logs.export" },
      { type: "separator" },
      {
        type: "item",
        label: "Share Feedback",
        href: "https://github.com/CYPHES-ATP/Stealth/issues/new",
      },
      {
        type: "item",
        label: "Report a Bug",
