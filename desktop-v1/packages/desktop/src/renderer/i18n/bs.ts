export const dict = {
  ...
  "desktop.updater.none.message": "Već koristiš najnoviju verziju Stealth-a",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija {{version}} Stealth-a je preuzeta. Želiš li da je instaliraš i ponovo pokreneš aplikaciju?",
