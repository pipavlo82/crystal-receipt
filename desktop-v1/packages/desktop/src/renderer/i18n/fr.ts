export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version d'Stealth",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} d'Stealth a été téléchargée. Voulez-vous l'installer et redémarrer ?",
