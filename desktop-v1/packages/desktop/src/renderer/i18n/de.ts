export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von Stealth",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von Stealth wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
