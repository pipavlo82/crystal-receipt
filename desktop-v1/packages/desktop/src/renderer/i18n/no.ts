export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av Stealth",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av Stealth er lastet ned. Vil du installere den og starte på nytt?",
