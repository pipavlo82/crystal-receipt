export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af Stealth",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af Stealth er blevet downloadet. Vil du installere den og genstarte?",
