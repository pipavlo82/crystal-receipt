...
if (!Array.isArray(fixture.vectors) || fixture.vectors.length !== 15) {
  throw new Error(`chronicle checkpoint continuity fixture must include exactly 15 vectors, found ${fixture.vectors?.length ?? 0}`)
}
